...
func setupTestGetConnection() *sql.DB {
	db, err := sql.Open("mysql", "root:my-secret-pw@tcp(localhost:3306)/belajar_golang_restful_api_test?parseTime=true")
